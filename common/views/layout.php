<?php
/**
 * Base MIS layout — professional design.
 * @var string $title
 * @var string $content
...
<aside class="sidebar" id="sidebar" aria-label="Main navigation">
    <div class="sidebar-brand">
        ...
        <span class="brand-text">BCD Survey</span>
    </div>

    <nav class="sidebar-nav">
        <div class="nav-section">Main</div>
        <a class="nav-link <?= $page === 'dashboard' ? 'active' : '' ?>" href="<?= url($user->homeUrl()) ?>">
            <i class="bi bi-speedometer2"></i><span class="nav-label">Dashboard</span>
        </a>

        <div class="nav-section">Data</div>
        <?php if ($user->hasPermission('survey_builder.view')): ?>
        <a class="nav-link <?= $page === 'builder' ? 'active' : '' ?>" href="<?= url('mis/builder/index.php') ?>">
            <i class="bi bi-ui-checks"></i><span class="nav-label">Survey Builder</span>
        </a>
        <?php endif; ?>
        <?php if ($user->hasPermission('masters.view')): ?>
        <a class="nav-link <?= $page === 'masters' ? 'active' : '' ?>" href="<?= url('mis/masters/index.php') ?>">
            <i class="bi bi-list-ul"></i><span class="nav-label">Masters</span>
        </a>
        <?php endif; ?>
        <?php if ($user->hasPermission('monitoring.view')): ?>
        <a class="nav-link <?= $page === 'monitoring' ? 'active' : '' ?>" href="<?= url('mis/monitoring.php') ?>">
            <i class="bi bi-eye"></i><span class="nav-label">Monitoring</span>
        </a>
        <?php endif; ?>
        <?php if ($user->hasPermission('gis.view')): ?>
        <a class="nav-link <?= $page === 'gis' ? 'active' : '' ?>" href="<?= url('gis/index.php') ?>">
            <i class="bi bi-geo-alt"></i><span class="nav-label">GIS</span>
        </a>
        <?php endif; ?>
        ...
        <a class="nav-link <?= $page === 'detail_report' ? 'active' : '' ?>" href="<?= url('mis/detail_report.php') ?>">
            <i class="bi bi-table"></i><span class="nav-label">Detailed Report</span>
        </a>
        <?php endif; ?>
        <?php if ($user->hasPermission('users.manage')): ?>
        <a class="nav-link <?= $page === 'users' ? 'active' : '' ?>" href="<?= url('mis/users/index.php') ?>">
            <i class="bi bi-people"></i><span class="nav-label">Users</span>
        </a>
        <?php endif; ?>
        <?php if ($user->isStateAdmin()): ?>
        <a class="nav-link" href="<?= url('admin/index.php') ?>">
            <i class="bi bi-shield-lock"></i><span class="nav-label">Admin Panel</span>
        </a>
        <?php endif; ?>
    </nav>

    <div class="sidebar-footer">
        <a class="nav-link" href="<?= url('mis/logout.php') ?>">
    ...
    <header class="topbar px-3 px-md-4">
        <div class="d-flex align-items-center gap-3 h-100 w-100">
            ...
            <nav class="breadcrumb" aria-label="breadcrumb">
                <ol class="breadcrumb">
                    <li class="breadcrumb-item d-none"><a href="<?= url($user->homeUrl()) ?>">MIS</a></li>
            ...
            <div class="ms-auto d-flex align-items-center gap-3">
                ...
                <div class="user-menu">
                    <div class="avatar"><?= e(strtoupper(substr($user->fullName(), 0, 2))) ?></div>
                    <div class="d-none d-md-block">
                        <div class="user-name"><?= e($user->fullName()) ?></div>
                        <div class="user-role"><?= e(implode(', ', $user->roleCodes())) ?></div>
                    </div>
                </div>
            </div>
        </div>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    if (collapseBtn && sidebar) {
        var collapsed = localStorage.getItem('mis-sidebar-collapsed') === 'true';
        if (collapsed) { sidebar.classList.add('collapsed'); }
        collapseBtn.addEventListener('click', function() {
            sidebar.classList.toggle('collapsed');
            localStorage.setItem('mis-sidebar-collapsed', sidebar.classList.contains('collapsed'));
        });
    }
});
</script>
